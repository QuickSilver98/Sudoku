public class SudokuSolver {
    ...
    public static void main(String[] args) {
        ...
        //The zeros represent the blanks in the grid
        int [][] board = {
                {7, 0, 2, 0, 5, 0, 6, 0, 0},
                {0, 0, 0, 0, 0, 3, 0, 0, 0},
                {1, 0, 0, 0, 0, 9, 5, 0, 0},
    ...
    private static boolean isNumberInBox(int [][] board,int number,int row,int column){
        /*this formula is used to find the location of a particular small box in
         the grid*/
        int localBoxRow = row - row % 3;
        int localBoxColumn = column - column % 3;

        //loop through the specified grid to look for the number
